...
contract("LemmaMainnet", accounts => {
    ...
    before(async function () {
        ...
        LemmaMainnetContract = await upgrades.deployProxy(LemmaMainnet, [usdcAddress, wethAddress, lemmaxDAIAddress, uniswapV2Router02Address, ambBridgeOnEth, multiTokenMediatorOnEth, trustedForwaderRinkeby], { initializer: 'initialize' });
